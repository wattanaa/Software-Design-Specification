...
function Room1() {
  ...
  async function createCalendarEvent() {
    ...
    const event = {
      ...
      สนามแข่งขัน:
          - ${stadiumZone.length > 0 ? stadiumZone.join(", ") : "ไม่ได้เลือก"}  

      ระบบที่ต้องใช้: 
          - ${selectedSystems.length > 0 ? selectedSystems.join(", ") : "ไม่ได้เลือก"}  

      ห้องที่ใช้: 
          - ${selectedRooms.length > 0 ? selectedRooms.join(", ") : "ไม่ได้เลือก"}  
