...
function Room1() {
  ...
  async function createCalendarEvent() {
    ...
    if (facilities.pool) selectedFacilities.push("สระว่ายน้ำ");
    if (facilities.grandstandA) selectedFacilities.push("อัฒจันทร์ โซน A");
    if (facilities.grandstandB) selectedFacilities.push("อัฒจันทร์ โซน B");
